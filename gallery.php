                ...
                <div class="directory-active row">
                        ...
                        <div class="properties__card">
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name col-lg-12">
                                    <span><h5 style="float:left;line-height:1.5"><i class="fa fa-bank pr-2"></i>College Festival</h5><a href="album.php"><button class="btn px-3" style="float:right;background-color:#FDD35F;border-radius:20px;">View</button></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="properties pb-20 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                        <div class="properties__card">
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name col-lg-12">
                                    <span><h5 style="float:left;line-height:1.5"><i class="fas fa-user-graduate pr-2"></i>Our Winners</h5><a href="rankers.php"><button class="btn px-3" style="float:right;background-color:#FDD35F;border-radius:20px;">View</button></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="properties pb-20 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="150">
                        <div class="properties__card">
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name col-lg-12">
                                    <span><h5 style="float:left;line-height:1.5"><i class="fab fa-youtube pr-2"></i>Youtube Videos</h5><a href="youtube.php"><button class="btn px-3" style="float:right;background-color:#FDD35F;border-radius:20px;">View</button></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
