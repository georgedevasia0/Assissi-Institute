    ...
    <section class="courses spad">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="course__item">
                        <img src="assets/img/courses/course-6.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="course__item">
                        ...
                        <p>People interested to join our courses at AIFL can stay at the hostels nearby our institution
                            on payment. Students can make their own alternate stay arrangements. Institution arranges
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="course__item">
                        ...
                        <p>First Aid box, sick room, staff room, administrative office, Water cooler, coffee-shop etc.
                        </p>
                    </div>
                </div>
            </div>
